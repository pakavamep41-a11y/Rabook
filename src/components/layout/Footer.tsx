...
import { Sparkles, MessageSquare, Instagram, Send, Flower2 } from "lucide-react";
...
export default function Footer() {
  ...
  return (
    <footer className="bg-slate-900 text-slate-400 text-sm border-t border-slate-800 mt-16 pb-20 md:pb-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1 flex flex-col gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="font-extrabold text-white text-lg">انتشارات رابوک</span>
            </div>
            <p className="leading-relaxed text-xs text-slate-400">
              رابوک یک مجموعه پویا در زمینه چاپ، نشر و تولید لوازم تحریر است. با ترکیب هنر، رنگ و کیفیت، سعی داریم تجربه‌ای تازه از نوشتن و برنامه‌ریزی خلق کنیم.
            </p>
            <div className="flex items-center gap-3 mt-2 text-slate-400">
               <a href="#" className="hover:text-emerald-500 transition-colors"><Instagram className="w-5 h-5"/></a>
               <a href="mailto:inforabok@gmail.com" className="hover:text-emerald-500 transition-colors"><Send className="w-5 h-5"/></a>
            </div>
          </div>
            ...
            <ul className="flex flex-col gap-2 text-xs">
              ...
              {(!footerMenu || footerMenu.items.length === 0) && (
                <>
                  ...
                  <li><Link to="/#catalog" className="hover:text-emerald-500 transition-colors">محصولات</Link></li>
                  <li><Link to="/account" className="hover:text-emerald-500 transition-colors">حساب کاربری</Link></li>
                </>
              )}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2 text-xs leading-relaxed text-slate-400">
              <li>تهران، دفتر انتشارات رابوک</li>
              <li className="font-mono">۰۲۱-۱۲۳۴۵۶۷۸</li>
              <li className="font-mono text-[10px]">inforabok@gmail.com</li>
              <li className="font-mono text-[10px]">www.Rabok.ir</li>
            </ul>
          </div>
        ...
        <div className="border-t border-slate-800 mt-12 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
          <p>© {usePersianDigits ? "۱۴۰۵" : "2026"} تمامی حقوق مادی و معنوی متعلق به انتشارات رابوک می‌باشد.</p>
